...
# Dockerized SaltStack Master v3002.4 _Magnesium_
...
```sh
docker pull cdalvaro/docker-salt-master:3002.4
```
...
[saltstack_badge]: https://img.shields.io/badge/SaltStack-v3002.4-lightgrey.svg?style=flat-square&logo=Saltstack
[saltstack_release_notes]: https://docs.saltstack.com/en/latest/topics/releases/3002.4.html "SaltStack Release Notes"
