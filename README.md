...
```sh
docker pull cdalvaro/saltstack-master:2019.2.2
```
...
docker run --name salt_master --detach \
    ...
    cdalvaro/saltstack-master:2019.2.2
```
...
docker run --name salt_stack -it --rm \
    --volume $(pwd)/keys/:/home/salt/data/keys/ \
    cdalvaro/saltstack-master:2019.2.2 app:gen-signed-keys other_master_sign
```
