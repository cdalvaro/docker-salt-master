...
<p align="center">
  ...
  <a href="https://docs.saltproject.io/en/3006/topics/releases/3006.24.html"><img alt="Salt Project" src="https://img.shields.io/badge/salt-3006.24%20lts-57BCAD.svg?logo=SaltProject"/></a>
...
```sh
docker pull ghcr.io/cdalvaro/docker-salt-master:3006.24
```
...
Hay un conjunto de imáges dedicadas con tags `-gui` que incluyen soporte integrado para [SaltGUI](https://github.com/erwindon/SaltGUI) `1.33.0`.
